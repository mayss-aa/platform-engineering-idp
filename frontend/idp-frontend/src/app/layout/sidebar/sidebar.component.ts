...
export interface NavItem {
  ...
  svgPath: string;
  badge?: string;
  /** Permissions required to see this nav item. Empty = any authenticated user. */
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        requiredPermissions: ['VIEW_DEPLOYMENTS'],
      },
      {
        label: 'Terraform',
        route: '/terraform',
        ...
        requiredPermissions: ['VIEW_TERRAFORM'],
      },
      {
        label: 'CI / CD',
        route: '/cicd',
    ...
    items: [
      {
        ...
        requiredPermissions: ['VIEW_CLOUD_RESOURCES'],
      },
      {
        label: 'Containers',
        route: '/containers',
      ...
      },
      {
        ...
        requiredPermissions: ['VIEW_KUBERNETES'],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        badge: '1',
        requiredPermissions: ['VIEW_INCIDENTS'],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        requiredPermissions: ['VIEW_TEAMS'],
      },
      {
        label: 'Users',
        route: '/users',
    ...
    items: [
      {
        ...
        requiredPermissions: ['VIEW_AI_ASSISTANT'],
      },
    ],
  },
];
...
export class SidebarComponent {
  ...
  /**
   * Filtered navigation groups — only shows items the current user has
   * permission to access. Groups with zero visible items are hidden entirely.
   * Reacts instantly to auth state changes via PermissionService (Requirement 3.12).
   */
      ...
      .map((group) => ({
        ...
        items: group.items.filter((item) => {
          if (!item.requiredPermissions || item.requiredPermissions.length === 0) {
            return true; // No permission required = visible to all authenticated users
          }
          return this.permissionService.hasAllPermissions(item.requiredPermissions);
        }),
      }))
